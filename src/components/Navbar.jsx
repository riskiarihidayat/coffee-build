...
export default function Navbar() {
  return (
    <nav className='flex flex-col fixed top-0 right-0 left-0 z-50'>
      <div className='py-5 bg-brown rounded-e-sm border-dashed border-b-[100%] border-b-2 border-[#847571] sm:flex sm:justify-between sm:items-center sm:px-14 md:px-24 lg:px-40 2xl:px-96'>
