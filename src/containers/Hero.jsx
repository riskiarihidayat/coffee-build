...
export default function Hero() {
  return (
    <section className='bg-brown pt-28 px-6 md:flex md:justify-between md:items-center md:gap-[72px] md:px-44'>
      <div className='mb-8 md:order-2'>
        ...
        <p className='font-sans text-mob-h4 font-normal text-white text-center mb-8 md:text-start md:text-desk-h4 md:mb-12'>
