...
export default function Testimonial() {
  return (
    <section id='testimonial' className='relative flex flex-col justify-center items-center px-12 pb-28 md:px-40 md:flex-row'>
      <div className='text-center mb-12 md:text-start md:flex-1'>
        <h1 className='section-title text-title mb-6'>Coffee is the best drink in the morning, it keeps you focused.</h1>
